(() => {
  ...
  function loadCompositor(){
    ...
    const s=document.createElement('script');s.src='./avatar-compositor-v1.js?v=13';s.defer=true;s.onload=()=>{compositorLoading=false;loadThumbs()};s.onerror=e=>{compositorLoading=false;fallback(e)};document.head.appendChild(s);
  }
  function wait(){
